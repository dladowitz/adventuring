...
$('.main .main_content .info .personal_info td.second_cell').click(function(){
  $(this).hide();
  $(this).parent().find('td.third_cell').show();
});

//Updates values from input box to default view. Save button saves to Database
$('.main .main_content .info .personal_info td.third_cell .update_button').click(function(){
...
$('.main .main_content .info .personal_info td.second_cell').hover(
